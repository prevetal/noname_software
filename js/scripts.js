...
document.addEventListener('DOMContentLoaded', function () {
	...
	// Footer
	let footerLinks = document.querySelectorAll('footer .col:nth-child(3) .links:nth-child(1), footer .col:nth-child(4) .links:nth-child(1), footer .col:nth-child(5) .links:nth-child(1)')

	if (footerLinks) {
		setHeight(footerLinks)
	}
...
window.addEventListener('resize', function () {
	...
	if (typeof WW !== 'undefined' && WW != windowW) {
		...
		footerLinks.forEach(el => el.style.height = 'auto')
...
function initMap() {
	ymaps.ready(() => {
		let myMap = new ymaps.Map('map', {
			center: [55.800494, 37.639204],
			zoom: 16,
			controls: []
		})

		// Кастомный маркер
		let myPlacemark = new ymaps.Placemark([55.800494, 37.639204], {}, {
